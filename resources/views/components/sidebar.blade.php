<div id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="/" class="list-group-item list-group-item-action"><i class="fas fa-outdent"></i>Saidas</a>
        ...
        <a href="#" class="list-group-item list-group-item-action"><i class="fas fa-layer-group"></i> Estoque</a>
    </div>
</div>
