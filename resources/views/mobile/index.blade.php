...
<div class="container-fluid">
    ...
    <div class="row ">
        ...
        <div class="col-sm-6">
            <a href="#" class="btn btn-dark btn-block btn-lg  group-mobile"> <i class="fas fa-user"></i> Funcionarios</a>
        </div>
    </div>
    <div class="row ">
        <div class="col-sm-6">
            <a href="#" class="btn btn-dark btn-block btn-lg  group-mobile"> <i class="fas fa-box-open"></i> Produtos</a>
        </div>
        <div class="col-sm-6">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <a href="#" class="btn btn-dark btn-lg btn-block  group-mobile"> <i class="fas fa-people-carry"></i> Fornecedor</a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
